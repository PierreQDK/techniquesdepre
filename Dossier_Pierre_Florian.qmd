...
df_erreurs_prevision <- tibble(
  Date = cac40_prev$date,
  Naive = log_cac40_prev_ts - prev_naive,
  ARIMA = log_cac40_prev_ts - prev_arima,
  Holt_Winters = log_cac40_prev_ts - prev_hw,
  ADAM_ETS = log_cac40_prev_ts - prev_adam_ets,
  ADAM_ETS_ARIMA = log_cac40_prev_ts - prev_adam_ets_arima,
  SSARIMA = log_cac40_prev_ts - prev_ssarima
)
...
errors_cumul <- tibble(
   ...
   Erreur_carrée = c(
     (log_cac40_prev_ts- prev_naive)^2,
     (log_cac40_prev_ts- prev_adam_ets)^2,
     (log_cac40_prev_ts - prev_adam_ets_arima)^2,
     (log_cac40_prev_ts - prev_arima)^2,
     (log_cac40_prev_ts - prev_hw)^2,
     (log_cac40_prev_ts - prev_ssarima)^2
   ),
   Modèle = rep(c("Naive", "ADAM.ETS", "ADAM.ETS.ARIMA", "ARIMA", "Holt-Winters", "SSARIMA"), each = 12)
)
errors_cumul
