...
cac40_train_2018 <- window(cac40_ts, end = c(2018, 12))
cac40_test_2019  <- window(cac40_ts, start = c(2019, 1), end = c(2019, 12))
...
cac40_train <- window(cac40_ts, end = c(2018, 12))

# Série de test : l’année 2019
cac40_test  <- window(cac40_ts, start = c(2019, 1), end = c(2019, 12))
