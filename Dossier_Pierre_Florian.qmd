...
Le test PP montre une statistique Z-tau de -14.733, bien inférieure aux valeurs critiques à 1%, 5%, et 10% (-3.459, -2.873, -2.573). De plus, la p-value pour le coefficient retardé est de 0.3794, ce qui signifie que l'on ne peut pas rejeter l'hypothèse nulle d'absence de racine unitaire. Le test confirme que, après différenciation, la série devient stationnaire, appuyant ainsi l'idée que la série est désormais stabilisée et ne présente plus de racine unitaire.
...
Le test de KPSS donne une statistique de test de 0.2108, qui est inférieure aux valeurs critiques à 1%, 5%, et 10% (0.739, 0.463, et 0.347 respectivement). Cela indique que nous ne rejetons pas l'hypothèse nulle de stationnarité de la série après différenciation. Ce résultat renforce les conclusions des tests ADF et PP, montrant que la série est devenue stationnaire après différenciation.
...
La p-value de 0.0007381, inférieure à 0.01, indique que l'hypothèse nulle est rejetée au seuil de risque de 1%. Cela signifie que les données ne suivent pas une distribution normale. Ainsi, la série différenciée du CAC 40 n'est pas normalement distribuée d'après le test de Shapiro-Wilk.
